...
\begin{itemize}
  ...
  all at AWS scale. Onboarded team members to projects, planned and coordinated devlopment work, and
  delivered all features ahead of schedule. 
  \item Advocated for, designed, and delivered projects that 
  resolved customer errors and overhauled error monitoring, causing 
  a 70\% drop in job failures and early identification of a critical 
  production bug. 
  \item Wrote the team standard for processes including release management,
